...
- **관리 탭**: 📋 예약 관리(KPI·필터·승인/거절·상세 모달·이력 추가/수정·영구 삭제·CSV 내보내기·**동의서 인쇄** — 상세 모달 🖨: 방문일·회사·방문자 명단 프리필로 서면 동의서 열기, 해시 전달이라 성명이 호스팅 로그에 안 남음, 2026-08-31) / 📊 통계 / 🚫 슬롯 제어 / 🔐 연동 계정 / 🎬 시연 시나리오 / 💡 조명 스위치 / ⚙️ 시스템 구성 / 📦 구비 가전(45개, `?type=appliances` fetch)
