...
- [ ] **동의서 관리자 연동 (법무 확정 후 착수)**: 예약 상세 모달 [동의서 인쇄] → 방문일·방문 회사·**방문자 명단(`visitors` JSON: 소속/이름/직급) 프리필**된 인쇄 뷰 — 현장에서는 도슨트 설명 후 **서명만** 받는 흐름 (운영자 요청 2026-08-31: 방문자가 현장에서 인적사항을 직접 기입하는 시간 낭비 제거). 서식 문안 확정 전 구현 시 재작업 위험 → 순서 고정.
